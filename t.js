      ...
      <nav style={styles.sidebar}>
        <div style={styles.sidebarTopSection}>
          <div style={styles.sidebarHeader} id="nomeEmpresaDisplay">
            <div style={styles.companyLogo}>W</div>
        ...
        <div id="tab-vendas" style={{...styles.pageContent, display: activeTab === "tab-vendas" ? "flex" : "none"}}>
          <div style={styles.card}>
            ...
            <div style={styles.grid2Cols}>
              ...
              <div style={styles.inputWrapper}>
                <label style={styles.labelInput}>Contato (Pombo)</label>
        ...
        <div style={styles.modalBody}>
          ...
          <div style={styles.modalForm}>
            ...
            <div style={styles.inputWrapper}>
              ...
              <input type="text" id="webhookVendasInput" style={styles.baseInput} disabled={session?.user?.name !== 'admin'} />
            </div>
            <div>
            ...
            <div style={styles.grid2Cols}>
              <div style={styles.inputWrapper}>
                ...
                <input type="color" id="colorPrimary" defaultValue={session?.user?.colorPrimary || "#d4a91c"} style={styles.colorPicker} disabled={session?.user?.name !== 'admin'} />
              </div>
              <div style={styles.inputWrapper}>
                <label style={styles.labelInput}>Cor Accent</label>
                <input type="color" id="colorAccent" style={styles.colorPicker} disabled={session?.user?.name !== 'admin'} />
              </div>
            </div>
